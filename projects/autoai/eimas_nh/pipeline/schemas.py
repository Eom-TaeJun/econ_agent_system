...
class EIMASResult:
    ...
    # Monetary Policy Intelligence view (2026-03-13)
    monetary_policy_memo: Dict = field(default_factory=dict)   # Compact memo artifact for policy/rates workflows
    nh_trading_memo: Dict = field(default_factory=dict)        # Compact memo artifact for NH Trading workflow
