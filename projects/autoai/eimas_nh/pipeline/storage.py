...
from pipeline.memo_view import populate_monetary_policy_memo
from pipeline.nh_memo_view import populate_nh_trading_memo
...
def save_result_json(
    ...
    try:
        populate_monetary_policy_memo(result)
        populate_nh_trading_memo(result)
...
def _json_to_full_markdown(data: dict, level: int = 1) -> str:
    ...
    section_order = [
        ...
        ('monetary_policy_memo', '37.5 Monetary Policy Memo View'),
        ('nh_trading_memo', '37.6 NH Trading Memo View'),
